...
cp ~/aws_adamacc/design/tl2/adamacc_aws.sv ./
cp ~/aws_adamacc/design/aws_wrappers/no_ddr/sh_bfm.sv $AWS_MODELS/sh_bfm
cp ~/aws_adamacc/design/aws_wrappers/no_ddr/fpga_ddr.svh $AWS_MODELS/fpga
