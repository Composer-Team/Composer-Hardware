...
class ALUConfig extends Config(new WithALUs(1) ++ new WithComposer() ++ new WithKriaPlatform)
object ALUConfig extends ComposerBuild(new ALUConfig)
...
//
//// Drivers
//object td extends ComposerBuild(new exampleConfig)