...
class GemmTestF1Big extends Config(
  new WithGemm(5, GemmParam(4, 256, 2, 8, 2048)) ++ new WithComposer(256 * 4 * 2) ++ new WithAWSMem(1)
)

class GemmTestF1Bigger extends Config(
  new WithGemm(8, GemmParam(4, 256, 2, 8, 2048)) ++ new WithComposer(256 * 4 * 2) ++ new WithAWSMem(1)
)
