...
object DieName {
  private[beethoven] val SLRRespRoutingFanout = 5
  private[beethoven] val SLRCmdRoutingFanout = 5
  private[beethoven] val CmdEndpointsPerSLR = 1
  private[beethoven] val RespEndpointsPerSLR = 2
