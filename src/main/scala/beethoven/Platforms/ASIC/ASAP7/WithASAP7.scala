...
//
//      os.copy.over(BeethovenBuild.targetDir, synwd / "src")
...
//        !BeethovenBuild.partitionModules.contains(tmod)
//      }
...
//
//
//      BeethovenBuild.partitionModules.distinct foreach { pMod =>
...
//        //             |
//        //             |
//        //             |read_verilog -library c1.nlib -design BeethovenTop -top BeethovenTop out/netlist.v
//        //             |
