//package beethoven.Platforms.ASIC.SAED
//
//import chipsalliance.rocketchip.config.{Config, Parameters}
//import chisel3.experimental.BaseModule
//import beethoven.MemoryStreams.{HasMemoryInterface, SD}
//import beethoven.Generation.BeethovenBuild
//import beethoven.MemoryStreams.RAM.RegMem
//import beethoven.Platforms.ASIC._
//import beethoven.Platforms._
//import beethoven.Platforms.ASIC.ProcessCorner.ProcessCorner
//import beethoven.Platforms.ASIC.ProcessOperatingConditions.ProcessOperatingConditions
//import beethoven.Platforms.ASIC.ProcessTemp.ProcessTemp
//import beethoven.Platforms.ASIC.ProcessVoltageThreshold.ProcessVoltageThreshold
//import os.Path
//
...
//    val cwd = os.Path(BeethovenBuild.beethovenGenDir)
...
//    BeethovenBuild.sourceList.foreach { src =>
...
//      }
//    }
//    os.copy.over(cwd / "beethoven.v", synwd / "src" / "beethoven.sv")
//
...
//    //      val memoryPaths: Seq[Path] = BeethovenBuild.symbolicMemoryResources.distinct.map(p => p / "db_nldm" / s"saed14sram_$cornerString$voltageString$tempString.db")
...
//         |report_host_options
//         |
//         |analyze -format sverilog [list src/beethoven.sv]
//         |elaborate BeethovenTop
//         |current_design BeethovenTop
//         |link
//         |uniquify
//         |
...
//         |
//         |write_sdc beethoven.sdc
//         |write -hierarchy -format verilog -output out/beethoven.netlist.v""".stripMargin
//
//    )
//
...
//    //      val referenceLibs = BeethovenBuild.symbolicMemoryResources.map(p => p/)
//    os.write(synwd / "pnr.tcl",
//      f"""set top_module BeethovenTop
//         |# set design_verilog "src/beethoven.v"
...
//         |
//         |
//         |read_verilog -library c1.nlib -design BeethovenTop -top BeethovenTop out/beethoven.netlist.v
//         |
