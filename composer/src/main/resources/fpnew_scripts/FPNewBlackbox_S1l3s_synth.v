...
module \$paramod$1ec311d8bbb78d5b213c030ce705238a3ade6dbb\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:149$544.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:149$545.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$528.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$529.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$538.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$539.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$540.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$541.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$542.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$543.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$528.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$529.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$529.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$528.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$528.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$529.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:149$544.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:149$545.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$528.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$529.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$538.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$539.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$540.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$541.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$542.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l3s.preprocessed.v:169$543.inp  = 3'hx;
endmodule
...
module \$paramod$4b918de69dcd218cd5910703264e623352cb07ac\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:327$456.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:327$457.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:347$454.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:347$455.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:327$456.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:327$457.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:347$454.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l3s.preprocessed.v:347$455.inp  = 2'hx;
endmodule

module \$paramod$6a56daa284ee7ecf4b17ad071518a3d0a64707d6\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$197.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$41.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$213.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$261.op ;
  ...
  assign _06_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$41.$result ;
  assign _07_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$41.$result  == 2'h1;
  assign _08_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$41.$result  == 2'h2;
  assign _09_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$41.$result  == 2'h3;
  function [1:0] _32_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$41.$result  = _32_(2'h2, 6'h07, { _15_, _13_, _11_ });
  assign _13_ = | _12_;
  assign _15_ = | _14_;
  assign _11_ = | _10_;
  assign _10_[0] = op_i == 4'ha;
  assign _10_[1] = op_i == 4'hb;
  assign _10_[2] = op_i == 4'hc;
  assign _10_[3] = op_i == 4'hd;
  assign _10_[4] = op_i == 4'he;
  assign _12_[0] = op_i == 4'h4;
  assign _12_[1] = op_i == 4'h5;
  assign _14_[0] = ! op_i;
  assign _14_[1] = op_i == 4'h1;
  assign _14_[2] = op_i == 4'h2;
  assign _14_[3] = op_i == 4'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _55_ = opgrp_in_ready;
  assign _16_ = _55_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$41.$result  +: 1];
  ...
  \$paramod$826e498915445693aef43ca278ffce27db920839\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$879a8a591151c59944abc27ae95089a017cb076c\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$73437f313346668773af7d9fa44f15f426bc9140\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$efc62cdce84b7ecc9bca3608f9f10e951a941395\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7827$197.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l3s.preprocessed.v:7876$261.op  = 4'hx;
...
module \$paramod$73437f313346668773af7d9fa44f15f426bc9140\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
...
module \$paramod$801e9fb1703a709ea20c8c1c48b091cb830061d3\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire [6:0] _003_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _061_ });
  ...
  assign _026_ = $signed(_076_) + $signed(32'd1);
  ...
  assign inject_carry_in = effective_subtraction & _063_;
  assign \gen_inside_pipeline[0].reg_ena  = inp_pipe_ready[1] & inp_pipe_valid_q[1];
  assign regular_status[1] = uf_after_round & regular_status[0];
  assign \gen_output_pipeline[0].reg_ena  = mid_pipe_ready[1] & mid_pipe_valid_q[1];
  reg [31:0] _101_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _101_ <= 32'd0;
    else if (\gen_output_pipeline[0].reg_ena ) _101_ <= result_d;
  assign out_pipe_result_q[31:0] = _101_;
  reg \out_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \out_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_030_) \out_pipe_valid_q_reg[0]  <= _002_;
  assign out_pipe_valid_q[1] = \out_pipe_valid_q_reg[0] ;
  reg \inp_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \inp_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_031_) \inp_pipe_valid_q_reg[0]  <= _000_;
  assign inp_pipe_valid_q[1] = \inp_pipe_valid_q_reg[0] ;
  reg [95:0] _104_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _104_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _104_ <= operands_i;
  assign inp_pipe_operands_q[95:0] = _104_;
  ...
  reg [4:0] _106_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _106_ <= 5'h00;
    else if (\gen_output_pipeline[0].reg_ena ) _106_ <= status_d;
  assign out_pipe_status_q[4:0] = _106_;
  reg [2:0] _107_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _107_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _107_ <= is_boxed_i;
  assign inp_pipe_is_boxed_q[2:0] = _107_;
  reg [2:0] _108_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _108_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _108_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[2:0] = _108_;
  reg [1:0] _109_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _109_ <= 2'h0;
    else if (\gen_inside_pipeline[0].reg_ena ) _109_ <= inp_pipe_tag_q[1:0];
  assign mid_pipe_tag_q[1:0] = _109_;
  reg [31:0] _110_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _110_ <= 32'd0;
    else if (\gen_inside_pipeline[0].reg_ena ) _110_ <= special_result;
  assign mid_pipe_spec_res_q[31:0] = _110_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _112_ <= inp_pipe_rnd_mode_q[2:0];
  assign mid_pipe_rnd_mode_q[2:0] = _112_;
  ...
  reg [75:0] _114_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _114_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _114_ <= mid_pipe_sum_q[151:76];
  assign mid_pipe_sum_q[75:0] = _114_;
  ...
  reg [6:0] _116_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _116_ <= 7'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _116_ <= addend_shamt;
  assign mid_pipe_add_shamt_q[6:0] = _116_;
  reg [9:0] _117_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _117_ <= 10'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _117_ <= sv2v_tmp_B4C85;
  assign mid_pipe_tent_exp_q[9:0] = _117_;
  reg [9:0] _118_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _118_ <= 10'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _118_ <= exponent_difference;
  assign mid_pipe_exp_diff_q[9:0] = _118_;
  reg [9:0] _119_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _119_ <= 10'h000;
    else if (\gen_inside_pipeline[0].reg_ena ) _119_ <= exponent_product;
  assign mid_pipe_exp_prod_q[9:0] = _119_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (_032_) \mid_pipe_valid_q_reg[0]  <= _001_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_input_pipeline[0].reg_ena ) _123_ <= tag_i;
  assign inp_pipe_tag_q[1:0] = _123_;
  ...
  reg [3:0] _125_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _125_ <= 4'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _125_ <= op_i;
  assign inp_pipe_op_q[3:0] = _125_;
  reg [1:0] _126_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _126_ <= 2'h0;
    else if (\gen_output_pipeline[0].reg_ena ) _126_ <= mid_pipe_tag_q[1:0];
  assign out_pipe_tag_q[1:0] = _126_;
  ...
  assign _030_ = | { mid_pipe_ready[1], flush_i };
  assign _031_ = | { in_ready_o, flush_i };
  assign _032_ = | { inp_pipe_ready[1], flush_i };
  assign _033_ = | { _071_, _068_ };
  assign _034_ = | { _071_, _070_, _069_ };
  assign _035_ = | { _071_, _070_, _069_, _068_ };
  assign _036_ = | { _071_, _070_, _068_ };
  assign _037_ = sum_raw[76] == tentative_sign;
  assign uf_after_round = ! rounded_abs[30:23];
  assign of_after_round = rounded_abs[30:23] == 8'hff;
  assign _038_ = $signed(_026_) >= $signed(32'd0);
  assign of_before_round = $signed(final_exponent) >= $signed(32'd255);
  assign _039_ = $signed(exponent_difference) > $signed(32'd0);
  assign _040_ = $signed(normalized_exponent) > $signed(32'd1);
  assign _041_ = $signed(exponent_difference) <= $signed(32'd4294967247);
  assign _042_ = $signed(exponent_difference) <= $signed(32'd26);
  assign _043_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd0);
  assign _044_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd2);
  assign _045_ = info_a[4] && info_b[5];
  assign _046_ = info_a[5] && info_b[4];
  assign _047_ = _055_ && info_c[4];
  assign _048_ = _047_ && effective_subtraction;
  assign _049_ = effective_subtraction && _064_;
  assign _050_ = effective_subtraction && _037_;
  assign _051_ = mid_pipe_eff_sub_q[1] && _044_;
  assign _052_ = _038_ && _053_;
  assign _053_ = ! lzc_zeroes;
  assign _054_ = _045_ || _046_;
  assign _055_ = info_a[4] || info_b[4];
  assign _056_ = info_a[5] || info_b[5];
  assign _057_ = _043_ || _051_;
  assign product = { info_a[7], mantissa_a[22:0] } * { info_b[7], operand_b[22:0] };
  assign _058_ = - sum_raw;
  assign _059_ = ~ inp_pipe_valid_q[1];
  assign _060_ = ~ inp_pipe_operands_q[31];
  assign _061_ = ~ info_c[7];
  assign _062_ = ~ addend_after_shift;
  assign _063_ = ~ sticky_before_add;
  assign _064_ = ~ sum_raw[76];
  assign _065_ = ~ mid_pipe_valid_q[1];
  assign _066_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = inp_pipe_ready[1] | _059_;
  assign inp_pipe_ready[1] = mid_pipe_ready[1] | _065_;
  assign sticky_after_norm = _072_ | mid_pipe_sticky_q[1];
  assign regular_status[2] = of_before_round | of_after_round;
  assign _067_ = _073_ | of_before_round;
  assign regular_status[0] = _067_ | of_after_round;
  assign mid_pipe_ready[1] = out_ready_i | _066_;
  assign _013_ = _040_ ? sum_shifted[74:50] : { 1'h0, sum_shifted[74:51] };
  assign _017_ = _040_ ? { sum_shifted[49:0], 1'h0 } : sum_shifted[50:0];
  assign _012_ = _040_ ? _077_[9:0] : 10'h000;
  assign _004_ = sum_shifted[75] ? normalized_exponent : _012_;
  assign _011_ = sum_shifted[75] ? sum_shifted[50:0] : _017_;
  assign _005_ = sum_shifted[75] ? { 1'h1, sum_shifted[74:51] } : _013_;
  ...
  assign final_exponent = sum_shifted[76] ? _029_[9:0] : _004_;
  assign _007_ = _052_ ? _026_[9:0] : 10'h000;
  assign _006_ = _052_ ? _027_[6:0] : _028_[6:0];
  assign normalized_exponent = _057_ ? _007_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _057_ ? _006_ : mid_pipe_add_shamt_q[6:0];
  assign _003_ = _042_ ? _075_[6:0] : 7'h00;
  assign addend_shamt = _041_ ? 7'h4c : _003_;
  assign _021_ = info_c[4] ? { operand_c[31], 31'h7f800000 } : 32'd2143289344;
  assign _020_ = _055_ ? { tentative_sign, 31'h7f800000 } : _021_;
  assign _019_ = _048_ ? 1'h1 : 1'h0;
  assign _018_ = _048_ ? 32'd2143289344 : _020_;
  ...
  assign mid_pipe_spec_stat_q[9] = _054_ ? 1'h1 : _010_;
  assign result_is_special = _054_ ? 1'h1 : _008_;
  assign special_result = _054_ ? 32'd2143289344 : _009_;
  function [0:0] _205_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[31] = _205_(1'h1, { _060_, 1'h0, inp_pipe_operands_q[31] }, { _070_, _069_, _033_ });
  function [30:0] _206_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _206_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _069_, _036_ });
  assign info_b = _035_ ? info_q[15:8] : 8'hff;
  function [7:0] _208_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_a = _208_(8'hff, { 8'h81, info_q[7:0] }, { _069_, _036_ });
  function [31:0] _209_;
    input [31:0] a;
    input [63:0] b;
    input [1:0] s;
  ...
  assign operand_c = _209_(32'd2155872257, { _085_, inp_pipe_operands_q[94:64], 32'h80000000 }, { _034_, _068_ });
  assign operand_b = _035_ ? inp_pipe_operands_q[63:32] : 32'd2155872257;
  function [7:0] _211_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_c = _211_(8'hff, { info_q[23:16], 8'h21 }, { _034_, _068_ });
  assign _068_ = inp_pipe_op_q[3:0] == 4'h3;
  assign _069_ = inp_pipe_op_q[3:0] == 4'h2;
  assign _070_ = inp_pipe_op_q[3:0] == 4'h1;
  assign _071_ = ! inp_pipe_op_q[3:0];
  ...
  assign _072_ = | sum_sticky_bits;
  assign _073_ = | round_sticky_bits;
  ...
  assign _074_ = _024_ - 32'd127;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _075_ = $signed(32'd27) - $signed(exponent_difference);
  assign _076_ = $signed(mid_pipe_exp_prod_q[9:0]) - $signed({ 1'h0, leading_zero_count });
  assign _077_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _078_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _078_;
  assign { _079_[31:10], exponent_product } = _056_ ? 32'd4294967171 : _074_;
  assign sv2v_tmp_B4C85 = _039_ ? exponent_addend : exponent_product;
  assign addend_shifted = effective_subtraction ? _062_ : addend_after_shift;
  assign { _080_[76], mid_pipe_sum_q[151:76] } = _049_ ? _058_ : sum_raw;
  assign _081_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign final_sign = _050_ ? 1'h1 : _081_;
  assign _082_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _082_;
  assign { _083_[31:8], pre_round_abs[30:23] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _084_ = mid_pipe_ready[1] ? mid_pipe_valid_q[1] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _084_;
  assign _085_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[1];
  ...
  assign _079_[9:0] = exponent_product;
  assign _080_[75:0] = mid_pipe_sum_q[151:76];
  assign _083_[7:0] = pre_round_abs[30:23];
...
module \$paramod$826e498915445693aef43ca278ffce27db920839\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [39:0] arbiter_output;
  ...
  \$paramod$cda0cce4e6ab9c5980a88b96e0036404e8f2dc15\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$879a8a591151c59944abc27ae95089a017cb076c\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module \$paramod$cda0cce4e6ab9c5980a88b96e0036404e8f2dc15\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
...
module \$paramod$efc62cdce84b7ecc9bca3608f9f10e951a941395\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module FPNewBlackbox_S1l3s_synth(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
