...
module \$paramod$0adf94592eb6a1684096a028d3c99c62d8322df7\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _066_ });
  ...
  reg [75:0] _112_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _112_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _112_ <= mid_pipe_sum_q[227:152];
  assign mid_pipe_sum_q[151:76] = _112_;
  ...
  reg [95:0] _114_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _114_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[0].reg_ena ) _114_ <= operands_i;
  assign inp_pipe_operands_q[191:96] = _114_;
  ...
  reg [95:0] _131_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _131_ <= 96'h000000000000000000000000;
    else if (\gen_input_pipeline[1].reg_ena ) _131_ <= inp_pipe_operands_q[191:96];
  assign inp_pipe_operands_q[95:0] = _131_;
  ...
  reg [31:0] _140_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _140_ <= 32'd0;
    else if (\gen_output_pipeline[0].reg_ena ) _140_ <= result_d;
  assign out_pipe_result_q[31:0] = _140_;
  ...
  reg [31:0] _144_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _144_ <= 32'd0;
    else if (\gen_inside_pipeline[1].reg_ena ) _144_ <= mid_pipe_spec_res_q[63:32];
  assign mid_pipe_spec_res_q[31:0] = _144_;
  ...
  reg [75:0] _148_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _148_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[1].reg_ena ) _148_ <= mid_pipe_sum_q[151:76];
  assign mid_pipe_sum_q[75:0] = _148_;
  ...
  reg [6:0] _150_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _150_ <= 7'h00;
    else if (\gen_inside_pipeline[1].reg_ena ) _150_ <= mid_pipe_add_shamt_q[13:7];
  assign mid_pipe_add_shamt_q[6:0] = _150_;
  reg [9:0] _151_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _151_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _151_ <= mid_pipe_tent_exp_q[19:10];
  assign mid_pipe_tent_exp_q[9:0] = _151_;
  reg [9:0] _152_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _152_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _152_ <= mid_pipe_exp_diff_q[19:10];
  assign mid_pipe_exp_diff_q[9:0] = _152_;
  reg [9:0] _153_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _153_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _153_ <= mid_pipe_exp_prod_q[19:10];
  assign mid_pipe_exp_prod_q[9:0] = _153_;
  ...
  assign mid_pipe_spec_res_q[63:32] = _159_;
  ...
  assign _041_ = sum_raw[76] == tentative_sign;
  ...
  assign _015_ = _044_ ? sum_shifted[74:50] : { 1'h0, sum_shifted[74:51] };
  assign _019_ = _044_ ? { sum_shifted[49:0], 1'h0 } : sum_shifted[50:0];
  assign _014_ = _044_ ? _083_[9:0] : 10'h000;
  assign _006_ = sum_shifted[75] ? normalized_exponent : _014_;
  assign _013_ = sum_shifted[75] ? sum_shifted[50:0] : _019_;
  assign _007_ = sum_shifted[75] ? { 1'h1, sum_shifted[74:51] } : _015_;
  ...
  assign final_exponent = sum_shifted[76] ? _031_[9:0] : _006_;
  assign _009_ = _056_ ? _028_[9:0] : 10'h000;
  assign _008_ = _056_ ? _029_[6:0] : _030_[6:0];
  assign normalized_exponent = _061_ ? _009_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _061_ ? _008_ : mid_pipe_add_shamt_q[6:0];
  assign _005_ = _046_ ? _081_[6:0] : 7'h00;
  assign addend_shamt = _045_ ? 7'h4c : _005_;
  assign _023_ = info_c[4] ? { operand_c[31], 31'h7f800000 } : 32'd2143289344;
  assign _022_ = _059_ ? { tentative_sign, 31'h7f800000 } : _023_;
  assign _021_ = _052_ ? 1'h1 : 1'h0;
  assign _020_ = _052_ ? 32'd2143289344 : _022_;
  ...
  assign special_result = _058_ ? 32'd2143289344 : _011_;
  function [0:0] _244_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign operand_a[31] = _244_(1'h1, { _065_, 1'h0, inp_pipe_operands_q[31] }, { _076_, _075_, _037_ });
  function [30:0] _245_;
    input [30:0] a;
    input [61:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[22:0] } = _245_(31'h00800001, { 31'h3f800000, inp_pipe_operands_q[30:0] }, { _075_, _040_ });
  ...
  assign operand_c = _248_(32'd2155872257, { _093_, inp_pipe_operands_q[94:64], 32'h80000000 }, { _038_, _074_ });
  ...
  assign _080_ = _026_ - 32'd127;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _081_ = $signed(32'd27) - $signed(exponent_difference);
  assign _082_ = $signed(mid_pipe_exp_prod_q[9:0]) - $signed({ 1'h0, leading_zero_count });
  ...
  assign { _086_[31:10], exponent_product } = _060_ ? 32'd4294967171 : _080_;
  ...
  assign { _087_[76], mid_pipe_sum_q[227:152] } = _053_ ? _062_ : sum_raw;
  ...
  assign _093_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[2];
  ...
  assign _086_[9:0] = exponent_product;
  assign _087_[75:0] = mid_pipe_sum_q[227:152];
...
module \$paramod$128addbfdd402102f1babcecb87987fdda33f129\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
...
module \$paramod$1abae49a203f061f794c248a8dda96e61e6460f3\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module \$paramod$1ec311d8bbb78d5b213c030ce705238a3ade6dbb\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:149$544.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:149$545.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$528.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$529.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$538.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$539.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$540.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$541.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$542.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$543.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$528.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$529.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$529.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$528.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$528.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$529.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:149$544.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:149$545.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$528.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$529.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$538.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$539.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$540.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$541.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$542.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l5s.preprocessed.v:169$543.inp  = 3'hx;
endmodule

module \$paramod$24493083199fe570d7c27023cec3ed0d203c4793\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$197.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$41.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$213.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$261.op ;
  ...
  assign _06_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$41.$result ;
  assign _07_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$41.$result  == 2'h1;
  assign _08_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$41.$result  == 2'h2;
  assign _09_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$41.$result  == 2'h3;
  function [1:0] _32_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$41.$result  = _32_(2'h2, 6'h07, { _15_, _13_, _11_ });
  assign _13_ = | _12_;
  assign _15_ = | _14_;
  assign _11_ = | _10_;
  ...
  assign _16_ = _55_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$41.$result  +: 1];
  ...
  \$paramod$37dcdea92fd2833824a4246d795d3d34b576ef7e\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$128addbfdd402102f1babcecb87987fdda33f129\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$1abae49a203f061f794c248a8dda96e61e6460f3\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f636fd7633e51daea428eb63b335ebbd1ea67854\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7827$197.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l5s.preprocessed.v:7876$261.op  = 4'hx;
...
module \$paramod$37dcdea92fd2833824a4246d795d3d34b576ef7e\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [39:0] arbiter_output;
  ...
  \$paramod$57b54a6a75a4a2c134b50fcd146369ee2e48d87d\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$4b918de69dcd218cd5910703264e623352cb07ac\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:327$456.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:327$457.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:347$454.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:347$455.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:327$456.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:327$457.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:347$454.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l5s.preprocessed.v:347$455.inp  = 2'hx;
endmodule

module \$paramod$57b54a6a75a4a2c134b50fcd146369ee2e48d87d\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
...
module \$paramod$f636fd7633e51daea428eb63b335ebbd1ea67854\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module FPNewBlackbox_S1l5s_synth(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
