...
module \$paramod$15e0f0475fbbaeb08de0e0ba4356251cf209ee11\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7883$195.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7883$41.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$127.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$162.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$211.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$227.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$243.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$259.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$57.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$92.$result ;
  ...
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1106  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1106 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1106 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1106 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1106 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1106 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1106 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1106 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1106 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1106 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1106 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1106 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1106 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1106 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1106 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1106 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1106 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$162.$result  = \$auto$proc_rom.cc:150:do_switch$1106 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1110  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1110 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1110 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1110 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1110 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1110 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1110 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1110 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1110 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1110 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1110 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1110 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1110 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1110 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1110 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1110 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1110 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$127.$result  = \$auto$proc_rom.cc:150:do_switch$1110 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1114  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1114 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1114 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1114 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1114 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1114 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1114 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1114 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1114 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1114 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1114 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1114 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1114 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1114 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1114 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1114 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1114 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$92.$result  = \$auto$proc_rom.cc:150:do_switch$1114 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1118  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1118 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1118 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1118 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1118 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1118 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1118 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1118 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1118 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1118 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1118 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1118 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1118 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1118 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1118 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1118 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1118 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$57.$result  = \$auto$proc_rom.cc:150:do_switch$1118 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1122  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1122 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1122 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1122 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1122 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1122 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1122 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1122 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1122 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1122 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1122 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1122 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1122 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1122 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1122 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1122 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1122 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7883$41.$result  = \$auto$proc_rom.cc:150:do_switch$1122 [op_i];
  ...
  assign _03_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$57.$result ;
  assign _04_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$92.$result  == 2'h1;
  assign _05_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$127.$result  == 2'h2;
  assign _06_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$162.$result  == 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _35_ = opgrp_in_ready;
  assign _07_ = _35_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7883$41.$result  +: 1];
  ...
  \$paramod$c01925b0c876ad688c5934e30842b7018d1e8038\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$e0210482bd7d9184c0c06d27802522bd6f06b34b\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f60fdde62450eb5a1a90c26f5bcfef12eed578c9\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$20e3dccc2ccfa250abf99191e551e06f6a0ebc1a\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7883$195.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$211.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$227.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$243.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l1s.preprocessed.v:7932$259.op  = 4'hx;
...
module \$paramod$20e3dccc2ccfa250abf99191e551e06f6a0ebc1a\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
...
module \$paramod$447df5b3a283065710c022398bea8ef33f939a95\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:327$436.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:327$437.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:347$434.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:347$435.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:327$436.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:327$437.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:347$434.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:347$435.inp  = 2'hx;
endmodule
...
module \$paramod$8118ffecf530c4a00ff25d76e99a97a31243b3b6\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
  ...
  \$paramod$85ac8369824556c9046584443a659b3a2e8e0616\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
...
module \$paramod$85ac8369824556c9046584443a659b3a2e8e0616\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire [4:0] _001_;
  wire [9:0] _002_;
  wire [8:0] _003_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[14:7] }) + $signed({ 9'h000, _056_ });
  assign _020_ = { 2'h0, exponent_a[7:0] } + info_a[6];
  assign _021_ = _020_ + { 2'h0, operand_b[14:7] };
  assign _022_ = _021_ + info_b[6];
  assign _023_ = { 10'h000, product, 2'h0 } + addend_shifted;
  assign sum_raw = _023_ + inject_carry_in;
  assign _025_ = 32'd10 + leading_zero_count;
  assign _024_ = $signed(_070_) + $signed(32'd1);
  assign _026_ = $signed(32'd10) + $signed(mid_pipe_exp_prod_q[9:0]);
  ...
  reg [27:0] _091_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _091_ <= 28'h0000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _091_ <= mid_pipe_sum_q[55:28];
  assign mid_pipe_sum_q[27:0] = _091_;
  ...
  reg [4:0] _098_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _098_ <= 5'h00;
    else if (\gen_inside_pipeline[0].reg_ena ) _098_ <= addend_shamt;
  assign mid_pipe_add_shamt_q[4:0] = _098_;
  reg [9:0] _099_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  assign _033_ = sum_raw[28] == tentative_sign;
  ...
  assign _037_ = $signed(exponent_difference) <= $signed(32'd4294967279);
  assign _038_ = $signed(exponent_difference) <= $signed(32'd10);
  ...
  assign _011_ = _036_ ? sum_shifted[26:18] : { 1'h0, sum_shifted[26:19] };
  assign _015_ = _036_ ? { sum_shifted[17:0], 1'h0 } : sum_shifted[18:0];
  assign _010_ = _036_ ? _071_[9:0] : 10'h000;
  assign _002_ = sum_shifted[27] ? normalized_exponent : _010_;
  assign _009_ = sum_shifted[27] ? sum_shifted[18:0] : _015_;
  assign _003_ = sum_shifted[27] ? { 1'h1, sum_shifted[26:19] } : _011_;
  assign final_mantissa = sum_shifted[28] ? { 1'h1, sum_shifted[27:20] } : _003_;
  assign sum_sticky_bits = sum_shifted[28] ? sum_shifted[19:1] : _009_;
  assign final_exponent = sum_shifted[28] ? _027_[9:0] : _002_;
  assign _005_ = _048_ ? _024_[9:0] : 10'h000;
  assign _004_ = _048_ ? _025_[4:0] : _026_[4:0];
  assign normalized_exponent = _053_ ? _005_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _053_ ? _004_ : mid_pipe_add_shamt_q[4:0];
  assign _001_ = _038_ ? _069_[4:0] : 5'h00;
  assign addend_shamt = _037_ ? 5'h1c : _001_;
  assign _019_ = info_c[4] ? { operand_c[15], 15'h7f80 } : 16'h7fc0;
  assign _018_ = _051_ ? { tentative_sign, 15'h7f80 } : _019_;
  assign _017_ = _044_ ? 1'h1 : 1'h0;
  assign _016_ = _044_ ? 16'h7fc0 : _018_;
  assign _014_ = any_operand_inf ? _017_ : 1'h0;
  assign _013_ = any_operand_inf ? _016_ : 16'h7fc0;
  ...
  assign operand_a[15] = _176_(1'h1, { _055_, 1'h0, operands_i[15] }, { _064_, _063_, _029_ });
  function [14:0] _177_;
    input [14:0] a;
    input [29:0] b;
    input [1:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[6:0] } = _177_(15'h0081, { 15'h3f80, operands_i[14:0] }, { _063_, _031_ });
  ...
  assign operand_c = _180_(16'h8081, { _077_, operands_i[46:32], 16'h8000 }, { _030_, _062_ });
  assign operand_b = _032_ ? operands_i[31:16] : 16'h8081;
  function [7:0] _182_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign _069_ = $signed(32'd11) - $signed(exponent_difference);
  ...
  assign { _073_[28], mid_pipe_sum_q[55:28] } = _045_ ? _054_ : sum_raw;
  ...
  assign { _076_[31:8], pre_round_abs[14:7] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _077_ = operands_i[47] ^ op_mod_i;
  ...
  assign _073_[27:0] = mid_pipe_sum_q[55:28];
  assign _076_[7:0] = pre_round_abs[14:7];
...
module \$paramod$c01925b0c876ad688c5934e30842b7018d1e8038\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [23:0] arbiter_output;
  ...
  \$paramod$8118ffecf530c4a00ff25d76e99a97a31243b3b6\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[4].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$e0210482bd7d9184c0c06d27802522bd6f06b34b\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module \$paramod$ea0afc4617438da89f766dca3e2e990528ae0bae\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:149$524.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:149$525.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$508.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$509.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$518.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$519.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$520.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$521.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$522.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$523.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$508.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$509.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$509.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$508.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$508.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$509.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:149$524.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:149$525.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$508.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$509.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$518.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$519.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$520.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$521.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$522.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l1s.preprocessed.v:169$523.inp  = 3'hx;
endmodule

module \$paramod$f60fdde62450eb5a1a90c26f5bcfef12eed578c9\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$15e0f0475fbbaeb08de0e0ba4356251cf209ee11\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
