...
module \$paramod$357ff6905b0741ef138e79a5db214fc994ff3525\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire [4:0] _000_;
  wire [9:0] _001_;
  wire [8:0] _002_;
  wire [4:0] _003_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[14:7] }) + $signed({ 9'h000, _054_ });
  assign _019_ = { 2'h0, exponent_a[7:0] } + info_a[6];
  assign _020_ = _019_ + { 2'h0, operand_b[14:7] };
  assign _021_ = _020_ + info_b[6];
  assign _022_ = { 10'h000, product, 2'h0 } + addend_shifted;
  assign sum_raw = _022_ + inject_carry_in;
  assign _024_ = 32'd10 + leading_zero_count;
  assign _023_ = $signed(_067_) + $signed(32'd1);
  assign _025_ = $signed(32'd10) + $signed(exponent_product);
  ...
  assign _031_ = sum_raw[28] == tentative_sign;
  ...
  assign _035_ = $signed(exponent_difference) <= $signed(32'd4294967279);
  assign _036_ = $signed(exponent_difference) <= $signed(32'd10);
  ...
  assign _010_ = _034_ ? sum_shifted[26:18] : { 1'h0, sum_shifted[26:19] };
  assign _014_ = _034_ ? { sum_shifted[17:0], 1'h0 } : sum_shifted[18:0];
  assign _009_ = _034_ ? _068_[9:0] : 10'h000;
  assign _001_ = sum_shifted[27] ? normalized_exponent : _009_;
  assign _008_ = sum_shifted[27] ? sum_shifted[18:0] : _014_;
  assign _002_ = sum_shifted[27] ? { 1'h1, sum_shifted[26:19] } : _010_;
  assign final_mantissa = sum_shifted[28] ? { 1'h1, sum_shifted[27:20] } : _002_;
  assign sum_sticky_bits = sum_shifted[28] ? sum_shifted[19:1] : _008_;
  assign final_exponent = sum_shifted[28] ? _026_[9:0] : _001_;
  assign _004_ = _046_ ? _023_[9:0] : 10'h000;
  assign _003_ = _046_ ? _024_[4:0] : _025_[4:0];
  assign normalized_exponent = _051_ ? _004_ : mid_pipe_tent_exp_q;
  assign norm_shamt = _051_ ? _003_ : addend_shamt;
  assign _000_ = _036_ ? _066_[4:0] : 5'h00;
  assign addend_shamt = _035_ ? 5'h1c : _000_;
  assign _018_ = info_c[4] ? { operand_c[15], 15'h7f80 } : 16'h7fc0;
  assign _017_ = _049_ ? { tentative_sign, 15'h7f80 } : _018_;
  assign _016_ = _042_ ? 1'h1 : 1'h0;
  assign _015_ = _042_ ? 16'h7fc0 : _017_;
  assign _013_ = any_operand_inf ? _016_ : 1'h0;
  assign _012_ = any_operand_inf ? _015_ : 16'h7fc0;
  ...
  assign _006_ = any_operand_nan ? 16'h7fc0 : _012_;
  assign special_status_q[4] = _048_ ? 1'h1 : _007_;
  assign result_is_special_q = _048_ ? 1'h1 : _005_;
  assign special_result_q = _048_ ? 16'h7fc0 : _006_;
  function [0:0] _153_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign { exponent_a[7:0], mantissa_a[6:0] } = _154_(15'h0081, { 15'h3f80, operands_i[14:0] }, { _060_, _028_ });
  ...
  assign operand_c = _157_(16'h8081, { _073_, operands_i[46:32], 16'h8000 }, { _027_, _059_ });
  assign operand_b = _030_ ? operands_i[31:16] : 16'h8081;
  ...
  assign { _070_[28], sum_q[27:19], sum_lower } = _043_ ? _052_ : sum_raw;
  assign _071_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign pre_round_sign = _044_ ? 1'h1 : _071_;
  assign { _072_[31:8], pre_round_abs[14:7] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _069_[9:0] = exponent_product;
  assign _070_[27:0] = { sum_q[27:19], sum_lower };
  assign _072_[7:0] = pre_round_abs[14:7];
  ...
  assign mid_pipe_sum_q = { sum_q[27:19], sum_lower };
  ...
  assign sum = { sum_q[27:19], sum_lower };
  assign sum_carry = sum_raw[28];
  assign sum_q[18:0] = sum_lower;
  ...
  assign sv2v_tmp_CEAB3 = { sum_q[27:19], sum_lower };
...
module \$paramod$426dceca9b79b29f479198720132d0e5a124d29e\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
  ...
  \$paramod$357ff6905b0741ef138e79a5db214fc994ff3525\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
...
module \$paramod$447df5b3a283065710c022398bea8ef33f939a95\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:327$436.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:327$437.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:347$434.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:347$435.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:327$436.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:327$437.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:347$434.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:347$435.inp  = 2'hx;
endmodule

module \$paramod$565780a21ad7e422f9cfed42346da23f0e40b9f8\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
...
module \$paramod$5c9d80d0df686a2db6f10d7f46b58957fc8522b6\fpnew_classifier (operands_i, is_boxed_i, info_o);
  ...
  assign _002_ = ! operands_i[46:39];
  assign _004_ = ! operands_i[14:7];
  assign _001_ = ! operands_i[22:16];
  assign _003_ = ! operands_i[38:32];
  assign _005_ = ! operands_i[6:0];
  assign _006_ = operands_i[30:23] == 8'hff;
  assign _007_ = operands_i[46:39] == 8'hff;
  assign _008_ = operands_i[14:7] == 8'hff;
  assign _009_ = ~ operands_i[22];
  assign _010_ = ~ operands_i[38];
  assign _011_ = ~ operands_i[6];
  ...
  assign \gen_num_values[1].is_subnormal  = _015_ && _027_;
  assign _016_ = is_boxed_i[2] && _002_;
  assign \gen_num_values[2].is_subnormal  = _016_ && _028_;
  assign _017_ = is_boxed_i[0] && _004_;
  assign \gen_num_values[0].is_subnormal  = _017_ && _029_;
  assign _018_ = _006_ && _001_;
  assign \gen_num_values[1].is_inf  = is_boxed_i[1] && _018_;
  assign _019_ = _007_ && _003_;
  assign \gen_num_values[2].is_inf  = is_boxed_i[2] && _019_;
  assign _020_ = _008_ && _005_;
  assign \gen_num_values[0].is_inf  = is_boxed_i[0] && _020_;
  assign _021_ = _006_ && _042_;
  assign _022_ = _007_ && _043_;
  assign _023_ = _008_ && _044_;
  assign _024_ = is_boxed_i[1] && \gen_num_values[1].is_nan ;
  assign \gen_num_values[1].is_signalling  = _024_ && _009_;
  assign _025_ = is_boxed_i[2] && \gen_num_values[2].is_nan ;
  assign \gen_num_values[2].is_signalling  = _025_ && _010_;
  assign _026_ = is_boxed_i[0] && \gen_num_values[0].is_nan ;
  assign \gen_num_values[0].is_signalling  = _026_ && _011_;
  assign \gen_num_values[0].is_quiet  = \gen_num_values[0].is_nan  && _035_;
  assign \gen_num_values[1].is_quiet  = \gen_num_values[1].is_nan  && _033_;
  assign \gen_num_values[2].is_quiet  = \gen_num_values[2].is_nan  && _034_;
  assign _027_ = ! \gen_num_values[1].is_zero ;
  assign _028_ = ! \gen_num_values[2].is_zero ;
  assign _029_ = ! \gen_num_values[0].is_zero ;
  assign _030_ = ! is_boxed_i[1];
  assign _031_ = ! is_boxed_i[2];
  assign _032_ = ! is_boxed_i[0];
  assign _033_ = ! \gen_num_values[1].is_signalling ;
  assign _034_ = ! \gen_num_values[2].is_signalling ;
  assign _035_ = ! \gen_num_values[0].is_signalling ;
  assign \gen_num_values[1].is_nan  = _030_ || _021_;
  assign \gen_num_values[2].is_nan  = _031_ || _022_;
  assign \gen_num_values[0].is_nan  = _032_ || _023_;
  assign _036_ = | operands_i[30:23];
  assign _037_ = operands_i[30:23] != 8'hff;
  assign _038_ = | operands_i[46:39];
  assign _039_ = operands_i[46:39] != 8'hff;
  assign _040_ = | operands_i[14:7];
  assign _041_ = operands_i[14:7] != 8'hff;
  assign _042_ = | operands_i[22:16];
  assign _043_ = | operands_i[38:32];
  assign _044_ = | operands_i[6:0];
...
module \$paramod$5fcd94f48e9d23da5409612e91fe061fb340e2fc\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module \$paramod$658dfe96446db0df18859893bf341f7d767c4c38\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [23:0] arbiter_output;
  ...
  \$paramod$426dceca9b79b29f479198720132d0e5a124d29e\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[4].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$a5e26072834b917bb28fa3e53bd56e65a3a6c274\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module \$paramod$ea0afc4617438da89f766dca3e2e990528ae0bae\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:149$524.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:149$525.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$508.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$509.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$518.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$519.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$520.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$521.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$522.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$523.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$508.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$509.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$509.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$508.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$508.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$509.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:149$524.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:149$525.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$508.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$509.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$518.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$519.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$520.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$521.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$522.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_B1l0s.preprocessed.v:169$523.inp  = 3'hx;
endmodule

module \$paramod$efaa2c657528c76cedbb4e32c7c6af462b7cc650\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7883$195.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7883$41.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$127.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$162.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$211.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$227.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$243.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$259.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$57.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$92.$result ;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1056  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1056 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1056 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1056 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1056 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1056 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1056 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1056 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1056 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1056 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1056 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1056 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1056 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1056 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1056 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1056 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1056 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$162.$result  = \$auto$proc_rom.cc:150:do_switch$1056 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1060  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1060 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1060 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1060 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1060 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1060 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1060 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1060 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1060 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1060 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1060 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1060 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1060 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1060 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1060 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1060 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1060 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$127.$result  = \$auto$proc_rom.cc:150:do_switch$1060 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1064  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1064 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1064 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1064 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1064 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1064 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1064 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1064 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1064 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1064 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1064 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1064 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1064 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1064 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1064 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1064 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1064 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$92.$result  = \$auto$proc_rom.cc:150:do_switch$1064 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1068  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1068 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1068 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1068 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1068 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1068 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1068 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1068 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1068 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1068 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1068 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1068 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1068 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1068 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1068 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1068 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1068 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$57.$result  = \$auto$proc_rom.cc:150:do_switch$1068 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1072  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1072 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1072 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1072 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1072 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1072 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1072 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1072 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1072 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1072 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1072 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1072 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1072 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1072 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1072 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1072 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1072 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7883$41.$result  = \$auto$proc_rom.cc:150:do_switch$1072 [op_i];
  ...
  assign _03_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$57.$result ;
  assign _04_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$92.$result  == 2'h1;
  assign _05_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$127.$result  == 2'h2;
  assign _06_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$162.$result  == 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _35_ = opgrp_in_ready;
  assign _07_ = _35_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7883$41.$result  +: 1];
  ...
  \$paramod$658dfe96446db0df18859893bf341f7d767c4c38\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$a5e26072834b917bb28fa3e53bd56e65a3a6c274\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$5fcd94f48e9d23da5409612e91fe061fb340e2fc\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$565780a21ad7e422f9cfed42346da23f0e40b9f8\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7883$195.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$211.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$227.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$243.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_B1l0s.preprocessed.v:7932$259.op  = 4'hx;
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$efaa2c657528c76cedbb4e32c7c6af462b7cc650\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
