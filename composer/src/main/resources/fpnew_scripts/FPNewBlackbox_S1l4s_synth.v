...
module \$paramod$12f1b250558b761ac63780fa5fd9c9caece1e369\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  ...
  \$paramod$206c49956af8758051d5a7726b3421d71d4db013\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[0].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$1ec311d8bbb78d5b213c030ce705238a3ade6dbb\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:149$544.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:149$545.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$528.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$529.$result ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$538.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$539.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$540.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$541.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$542.inp ;
  wire [2:0] \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$543.inp ;
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$528.$result [1:0] } : { 1'h0, \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$529.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$529.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$528.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$528.$result [1:0], \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$529.$result [1:0], idx_o };
  ...
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:149$544.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:149$545.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$528.$result [2] = 1'h1;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$529.$result [2] = 1'h0;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$538.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$539.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$540.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$541.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$542.inp  = 3'hx;
  assign \sv2v_cast_1BFE4$func$FPNewBlackbox_S1l4s.preprocessed.v:169$543.inp  = 3'hx;
endmodule

module \$paramod$206c49956af8758051d5a7726b3421d71d4db013\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
...
module \$paramod$4b918de69dcd218cd5910703264e623352cb07ac\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:327$456.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:327$457.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:347$454.inp ;
  wire [1:0] \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:347$455.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:327$456.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:327$457.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:347$454.inp  = 2'hx;
  assign \sv2v_cast_71D7F$func$FPNewBlackbox_S1l4s.preprocessed.v:347$455.inp  = 2'hx;
endmodule

module \$paramod$52ab3e2f3d540d3f1c55d27e24e02ed25f8d28c5\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$197.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$41.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$213.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$229.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$245.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$261.op ;
  ...
  assign _06_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$41.$result ;
  assign _07_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$41.$result  == 2'h1;
  assign _08_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$41.$result  == 2'h2;
  assign _09_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$41.$result  == 2'h3;
  function [1:0] _32_;
    input [1:0] a;
    input [5:0] b;
    input [2:0] s;
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$41.$result  = _32_(2'h2, 6'h07, { _15_, _13_, _11_ });
  assign _13_ = | _12_;
  assign _15_ = | _14_;
  assign _11_ = | _10_;
  ...
  assign _16_ = _55_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$41.$result  +: 1];
  ...
  \$paramod$12f1b250558b761ac63780fa5fd9c9caece1e369\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$549f68137867e3642112cc3be0f1f499dc380643\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$e24072fcf90674aab354d0487e7b05abfd232acb\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$da9751a058831289ffa177eaa7d15e59f622c51f\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7827$197.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$213.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$229.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$245.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_S1l4s.preprocessed.v:7876$261.op  = 4'hx;
...
module \$paramod$549f68137867e3642112cc3be0f1f499dc380643\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module \$paramod$d6fe7e1febab4c8b06cc538661f24974710e47f9\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[30:23] }) + $signed({ 9'h000, _063_ });
  ...
  assign _027_ = $signed(_079_) + $signed(32'd1);
  ...
  assign inject_carry_in = effective_subtraction & _065_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (_031_) \mid_pipe_valid_q_reg[0]  <= _001_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[1].reg_ena ) _111_ <= mid_pipe_exp_prod_q[19:10];
  ...
  reg [2:0] _113_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _113_ <= 3'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _113_ <= rnd_mode_i;
  assign inp_pipe_rnd_mode_q[2:0] = _113_;
  reg [1:0] _114_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _114_ <= 2'h0;
    else if (\gen_inside_pipeline[0].reg_ena ) _114_ <= inp_pipe_tag_q[1:0];
  assign mid_pipe_tag_q[3:2] = _114_;
  reg [31:0] _115_;
  always @(posedge clk_i, negedge rst_ni)
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[0].reg_ena ) _117_ <= inp_pipe_rnd_mode_q[2:0];
  ...
  reg [1:0] _128_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _128_ <= 2'h0;
    else if (\gen_input_pipeline[0].reg_ena ) _128_ <= tag_i;
  assign inp_pipe_tag_q[1:0] = _128_;
  ...
  reg [1:0] _132_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _132_ <= 2'h0;
    else if (\gen_output_pipeline[0].reg_ena ) _132_ <= mid_pipe_tag_q[1:0];
  assign out_pipe_tag_q[1:0] = _132_;
  reg [4:0] _133_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _133_ <= 5'h00;
    else if (\gen_output_pipeline[0].reg_ena ) _133_ <= status_d;
  assign out_pipe_status_q[4:0] = _133_;
  reg [31:0] _134_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _134_ <= 32'd0;
    else if (\gen_output_pipeline[0].reg_ena ) _134_ <= result_d;
  assign out_pipe_result_q[31:0] = _134_;
  reg \out_pipe_valid_q_reg[0] ;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) \out_pipe_valid_q_reg[0]  <= 1'h0;
    else if (_034_) \out_pipe_valid_q_reg[0]  <= _003_;
  ...
  always @(posedge clk_i, negedge rst_ni)
    ...
    else if (\gen_inside_pipeline[1].reg_ena ) _137_ <= mid_pipe_tag_q[3:2];
  assign mid_pipe_tag_q[1:0] = _137_;
  reg [31:0] _138_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _138_ <= 32'd0;
    else if (\gen_inside_pipeline[1].reg_ena ) _138_ <= mid_pipe_spec_res_q[63:32];
  assign mid_pipe_spec_res_q[31:0] = _138_;
  ...
  reg [2:0] _140_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _140_ <= 3'h0;
    else if (\gen_inside_pipeline[1].reg_ena ) _140_ <= mid_pipe_rnd_mode_q[5:3];
  assign mid_pipe_rnd_mode_q[2:0] = _140_;
  ...
  reg [75:0] _142_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _142_ <= 76'h0000000000000000000;
    else if (\gen_inside_pipeline[1].reg_ena ) _142_ <= mid_pipe_sum_q[151:76];
  assign mid_pipe_sum_q[75:0] = _142_;
  ...
  reg [6:0] _144_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _144_ <= 7'h00;
    else if (\gen_inside_pipeline[1].reg_ena ) _144_ <= mid_pipe_add_shamt_q[13:7];
  assign mid_pipe_add_shamt_q[6:0] = _144_;
  reg [9:0] _145_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _145_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _145_ <= mid_pipe_exp_diff_q[19:10];
  assign mid_pipe_exp_diff_q[9:0] = _145_;
  reg [9:0] _146_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _146_ <= 10'h000;
    else if (\gen_inside_pipeline[1].reg_ena ) _146_ <= mid_pipe_tent_exp_q[19:10];
  assign mid_pipe_tent_exp_q[9:0] = _146_;
  ...
  assign _040_ = $signed(_027_) >= $signed(32'd0);
  assign of_before_round = $signed(final_exponent) >= $signed(32'd255);
  assign _041_ = $signed(exponent_difference) > $signed(32'd0);
  assign _042_ = $signed(normalized_exponent) > $signed(32'd1);
  assign _043_ = $signed(exponent_difference) <= $signed(32'd4294967247);
  assign _044_ = $signed(exponent_difference) <= $signed(32'd26);
  assign _045_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd0);
  assign _046_ = $signed(mid_pipe_exp_diff_q[9:0]) <= $signed(32'd2);
  assign _047_ = info_a[4] && info_b[5];
  assign _048_ = info_a[5] && info_b[4];
  assign _049_ = _057_ && info_c[4];
  assign _050_ = _049_ && effective_subtraction;
  assign _051_ = effective_subtraction && _066_;
  assign _052_ = effective_subtraction && _039_;
  assign _053_ = mid_pipe_eff_sub_q[2] && _046_;
  assign _054_ = _040_ && _055_;
  assign _055_ = ! lzc_zeroes;
  assign _056_ = _047_ || _048_;
  assign _057_ = info_a[4] || info_b[4];
  assign _058_ = info_a[5] || info_b[5];
  assign _059_ = _045_ || _053_;
  assign product = { info_a[7], mantissa_a[22:0] } * { info_b[7], operand_b[22:0] };
  assign _060_ = - sum_raw;
  assign _061_ = ~ inp_pipe_valid_q[1];
  assign _062_ = ~ inp_pipe_operands_q[31];
  assign _063_ = ~ info_c[7];
  assign _064_ = ~ addend_after_shift;
  assign _065_ = ~ sticky_before_add;
  assign _066_ = ~ sum_raw[76];
  assign _067_ = ~ mid_pipe_valid_q[1];
  assign _068_ = ~ mid_pipe_valid_q[2];
  assign _069_ = ~ out_pipe_valid_q[1];
  assign in_ready_o = inp_pipe_ready[1] | _061_;
  assign inp_pipe_ready[1] = mid_pipe_ready[1] | _067_;
  assign mid_pipe_ready[1] = mid_pipe_ready[2] | _068_;
  assign sticky_after_norm = _075_ | mid_pipe_sticky_q[2];
  assign regular_status[2] = of_before_round | of_after_round;
  assign _070_ = _076_ | of_before_round;
  assign regular_status[0] = _070_ | of_after_round;
  assign mid_pipe_ready[2] = out_ready_i | _069_;
  assign _014_ = _042_ ? sum_shifted[74:50] : { 1'h0, sum_shifted[74:51] };
  assign _018_ = _042_ ? { sum_shifted[49:0], 1'h0 } : sum_shifted[50:0];
  assign _013_ = _042_ ? _080_[9:0] : 10'h000;
  assign _005_ = sum_shifted[75] ? normalized_exponent : _013_;
  assign _012_ = sum_shifted[75] ? sum_shifted[50:0] : _018_;
  assign _006_ = sum_shifted[75] ? { 1'h1, sum_shifted[74:51] } : _014_;
  ...
  assign final_exponent = sum_shifted[76] ? _030_[9:0] : _005_;
  assign _008_ = _054_ ? _027_[9:0] : 10'h000;
  assign _007_ = _054_ ? _028_[6:0] : _029_[6:0];
  assign normalized_exponent = _059_ ? _008_ : mid_pipe_tent_exp_q[9:0];
  assign norm_shamt = _059_ ? _007_ : mid_pipe_add_shamt_q[6:0];
  assign _004_ = _044_ ? _078_[6:0] : 7'h00;
  assign addend_shamt = _043_ ? 7'h4c : _004_;
  assign _022_ = info_c[4] ? { operand_c[31], 31'h7f800000 } : 32'd2143289344;
  assign _021_ = _057_ ? { tentative_sign, 31'h7f800000 } : _022_;
  assign _020_ = _050_ ? 1'h1 : 1'h0;
  assign _019_ = _050_ ? 32'd2143289344 : _021_;
  ...
  assign mid_pipe_spec_stat_q[14] = _056_ ? 1'h1 : _011_;
  assign result_is_special = _056_ ? 1'h1 : _009_;
  assign special_result = _056_ ? 32'd2143289344 : _010_;
  function [0:0] _228_;
    input [0:0] a;
    input [2:0] b;
    input [2:0] s;
  ...
  assign info_b = _037_ ? info_q[15:8] : 8'hff;
  function [7:0] _231_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign info_a = _231_(8'hff, { 8'h81, info_q[7:0] }, { _072_, _038_ });
  function [31:0] _232_;
    input [31:0] a;
    input [63:0] b;
    input [1:0] s;
  ...
  assign operand_c = _232_(32'd2155872257, { _089_, inp_pipe_operands_q[94:64], 32'h80000000 }, { _036_, _071_ });
  assign operand_b = _037_ ? inp_pipe_operands_q[63:32] : 32'd2155872257;
  function [7:0] _234_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign _071_ = inp_pipe_op_q[3:0] == 4'h3;
  assign _072_ = inp_pipe_op_q[3:0] == 4'h2;
  assign _073_ = inp_pipe_op_q[3:0] == 4'h1;
  assign _074_ = ! inp_pipe_op_q[3:0];
  ...
  assign _075_ = | sum_sticky_bits;
  assign _076_ = | round_sticky_bits;
  ...
  assign _077_ = _025_ - 32'd127;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _078_ = $signed(32'd27) - $signed(exponent_difference);
  assign _079_ = $signed(mid_pipe_exp_prod_q[9:0]) - $signed({ 1'h0, leading_zero_count });
  assign _080_ = $signed(normalized_exponent) - $signed(32'd1);
  assign _081_ = in_ready_o ? in_valid_i : 1'hx;
  assign _000_ = flush_i ? 1'h0 : _081_;
  assign { _082_[31:10], exponent_product } = _058_ ? 32'd4294967171 : _077_;
  assign sv2v_tmp_B4C85 = _041_ ? exponent_addend : exponent_product;
  assign addend_shifted = effective_subtraction ? _064_ : addend_after_shift;
  assign { _083_[76], mid_pipe_sum_q[227:152] } = _051_ ? _060_ : sum_raw;
  assign _084_ = effective_subtraction ? 1'h0 : tentative_sign;
  assign final_sign = _052_ ? 1'h1 : _084_;
  assign _085_ = inp_pipe_ready[1] ? inp_pipe_valid_q[1] : 1'hx;
  assign _002_ = flush_i ? 1'h0 : _085_;
  assign _086_ = mid_pipe_ready[1] ? mid_pipe_valid_q[1] : 1'hx;
  assign _001_ = flush_i ? 1'h0 : _086_;
  assign { _087_[31:8], pre_round_abs[30:23] } = of_before_round ? 32'd254 : { 24'h000000, final_exponent[7:0] };
  ...
  assign _088_ = mid_pipe_ready[2] ? mid_pipe_valid_q[2] : 1'hx;
  assign _003_ = flush_i ? 1'h0 : _088_;
  assign _089_ = inp_pipe_operands_q[95] ^ inp_pipe_op_mod_q[1];
...
module \$paramod$da9751a058831289ffa177eaa7d15e59f622c51f\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module \$paramod$e24072fcf90674aab354d0487e7b05abfd232acb\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [39:0] arbiter_output;
  output busy_o;
...
module FPNewBlackbox_S1l4s_synth(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
