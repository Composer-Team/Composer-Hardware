...
module \$paramod$049427e5d937e8eea05082c71822b573a445cbd0\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
  ...
  \$paramod$d5dce96289315bec776e27887afe8e3ac0a5de01\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
...
module \$paramod$447df5b3a283065710c022398bea8ef33f939a95\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:327$436.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:327$437.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:347$434.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:347$435.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:327$436.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:327$437.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:347$434.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:347$435.inp  = 2'hx;
endmodule
...
module \$paramod$976b595f3e1759b9a8a5a7b814da34b9f0472367\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7883$195.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7883$41.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$127.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$162.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$211.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$227.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$243.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$259.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$57.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$92.$result ;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1121  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1121 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1121 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1121 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1121 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1121 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1121 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1121 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1121 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1121 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1121 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1121 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1121 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1121 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1121 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1121 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1121 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$162.$result  = \$auto$proc_rom.cc:150:do_switch$1121 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1125  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1125 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1125 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1125 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1125 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1125 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1125 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1125 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1125 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1125 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1125 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1125 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1125 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1125 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1125 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1125 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1125 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$127.$result  = \$auto$proc_rom.cc:150:do_switch$1125 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1129  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1129 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1129 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1129 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1129 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1129 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1129 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1129 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1129 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1129 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1129 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1129 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1129 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1129 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1129 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1129 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1129 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$92.$result  = \$auto$proc_rom.cc:150:do_switch$1129 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1133  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1133 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1133 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1133 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1133 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1133 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1133 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1133 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1133 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1133 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1133 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1133 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1133 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1133 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1133 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1133 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1133 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$57.$result  = \$auto$proc_rom.cc:150:do_switch$1133 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1137  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1137 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1137 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1137 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1137 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1137 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1137 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1137 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1137 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1137 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1137 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1137 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1137 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1137 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1137 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1137 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1137 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7883$41.$result  = \$auto$proc_rom.cc:150:do_switch$1137 [op_i];
  ...
  assign _03_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$57.$result ;
  assign _04_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$92.$result  == 2'h1;
  assign _05_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$127.$result  == 2'h2;
  assign _06_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$162.$result  == 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _35_ = opgrp_in_ready;
  assign _07_ = _35_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7883$41.$result  +: 1];
  ...
  \$paramod$bdde8d90cf0629d491195c16c3edab99ff2114eb\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$f440a4feb47a290f0da2e40b1746020c947f475d\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$aadd61d6302d49aae233a438dcc16e0be1166ec2\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$fbf81fc3d82755ad6b74a4389a43ab6348ecb610\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7883$195.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$211.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$227.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$243.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l1s.preprocessed.v:7932$259.op  = 4'hx;
...
module \$paramod$aadd61d6302d49aae233a438dcc16e0be1166ec2\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
...
module \$paramod$bdde8d90cf0629d491195c16c3edab99ff2114eb\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  wire [23:0] arbiter_output;
  ...
  \$paramod$049427e5d937e8eea05082c71822b573a445cbd0\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[2].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$d5dce96289315bec776e27887afe8e3ac0a5de01\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire [5:0] _001_;
  wire [6:0] _002_;
  wire [11:0] _003_;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[14:10] }) + $signed({ 6'h00, _056_ });
  assign _020_ = { 2'h0, exponent_a[4:0] } + info_a[6];
  assign _021_ = _020_ + { 2'h0, operand_b[14:10] };
  assign _022_ = _021_ + info_b[6];
  assign _023_ = { 13'h0000, product, 2'h0 } + addend_shifted;
  assign sum_raw = _023_ + inject_carry_in;
  assign _025_ = 32'd13 + leading_zero_count;
  assign _024_ = $signed(_070_) + $signed(32'd1);
  assign _026_ = $signed(32'd13) + $signed(mid_pipe_exp_prod_q[6:0]);
  ...
  reg [36:0] _091_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _091_ <= 37'h0000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _091_ <= mid_pipe_sum_q[73:37];
  assign mid_pipe_sum_q[36:0] = _091_;
  ...
  assign _033_ = sum_raw[37] == tentative_sign;
  ...
  assign _037_ = $signed(exponent_difference) <= $signed(32'd4294967273);
  assign _038_ = $signed(exponent_difference) <= $signed(32'd13);
  assign _039_ = $signed(mid_pipe_exp_diff_q[6:0]) <= $signed(32'd0);
  assign _040_ = $signed(mid_pipe_exp_diff_q[6:0]) <= $signed(32'd2);
  ...
  assign _011_ = _036_ ? sum_shifted[35:24] : { 1'h0, sum_shifted[35:25] };
  assign _015_ = _036_ ? { sum_shifted[23:0], 1'h0 } : sum_shifted[24:0];
  assign _010_ = _036_ ? _071_[6:0] : 7'h00;
  assign _002_ = sum_shifted[36] ? normalized_exponent : _010_;
  assign _009_ = sum_shifted[36] ? sum_shifted[24:0] : _015_;
  assign _003_ = sum_shifted[36] ? { 1'h1, sum_shifted[35:25] } : _011_;
  assign final_mantissa = sum_shifted[37] ? { 1'h1, sum_shifted[36:26] } : _003_;
  assign sum_sticky_bits = sum_shifted[37] ? sum_shifted[25:1] : _009_;
  assign final_exponent = sum_shifted[37] ? _027_[6:0] : _002_;
  assign _005_ = _048_ ? _024_[6:0] : 7'h00;
  assign _004_ = _048_ ? _025_[5:0] : _026_[5:0];
  assign normalized_exponent = _053_ ? _005_ : mid_pipe_tent_exp_q[6:0];
  assign norm_shamt = _053_ ? _004_ : mid_pipe_add_shamt_q[5:0];
  assign _001_ = _038_ ? _069_[5:0] : 6'h00;
  assign addend_shamt = _037_ ? 6'h25 : _001_;
  assign _019_ = info_c[4] ? { operand_c[15], 15'h7c00 } : 16'h7e00;
  assign _018_ = _051_ ? { tentative_sign, 15'h7c00 } : _019_;
  assign _017_ = _044_ ? 1'h1 : 1'h0;
  assign _016_ = _044_ ? 16'h7e00 : _018_;
  assign _014_ = any_operand_inf ? _017_ : 1'h0;
  assign _013_ = any_operand_inf ? _016_ : 16'h7e00;
  ...
  assign { exponent_a[4:0], mantissa_a[9:0] } = _177_(15'h0401, { 15'h3c00, operands_i[14:0] }, { _063_, _031_ });
  ...
  assign operand_c = _180_(16'h8401, { _077_, operands_i[46:32], 16'h8000 }, { _030_, _062_ });
  assign operand_b = _032_ ? operands_i[31:16] : 16'h8401;
  function [7:0] _182_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign _068_ = _022_ - 32'd15;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _069_ = $signed(32'd14) - $signed(exponent_difference);
  assign _070_ = $signed(mid_pipe_exp_prod_q[6:0]) - $signed({ 1'h0, leading_zero_count });
  assign _071_ = $signed(normalized_exponent) - $signed(32'd1);
  assign { _072_[31:7], exponent_product } = _052_ ? 32'd4294967283 : _068_;
  ...
  assign { _073_[37], mid_pipe_sum_q[73:37] } = _045_ ? _054_ : sum_raw;
  ...
  assign { _076_[31:5], pre_round_abs[14:10] } = of_before_round ? 32'd30 : { 27'h0000000, final_exponent[4:0] };
  ...
  assign _072_[6:0] = exponent_product;
  assign _073_[36:0] = mid_pipe_sum_q[73:37];
  assign _076_[4:0] = pre_round_abs[14:10];
...
module \$paramod$ea0afc4617438da89f766dca3e2e990528ae0bae\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:149$524.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:149$525.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$508.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$509.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$518.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$519.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$520.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$521.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$522.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$523.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$508.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$509.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$509.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$508.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$508.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$509.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:149$524.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:149$525.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$508.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$509.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$518.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$519.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$520.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$521.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$522.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l1s.preprocessed.v:169$523.inp  = 3'hx;
endmodule
...
module \$paramod$f440a4feb47a290f0da2e40b1746020c947f475d\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module \$paramod$fbf81fc3d82755ad6b74a4389a43ab6348ecb610\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$976b595f3e1759b9a8a5a7b814da34b9f0472367\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
