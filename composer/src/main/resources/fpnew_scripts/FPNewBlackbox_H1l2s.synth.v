...
module \$paramod$2c3f0f0ab5cf2e7e1dc2c81d2f6435db1d0dee7d\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire _1_;
  ...
  \$paramod$65a6fd5a1b819e7d7d2a2211773490ca20062739\fpnew_opgroup_fmt_slice_E368D_75924  \gen_parallel_slices[2].active_format.i_fmt_slice  (
    .busy_o(busy_o),
    .clk_i(clk_i),
...
module \$paramod$362e4fefcada2c1e759d925fe54e5e56d459c241\fpnew_fma_FC83A_5615B (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, tag_i, aux_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, aux_o, out_valid_o, out_ready_i, busy_o);
  wire _000_;
  wire _001_;
  wire [5:0] _002_;
  wire [6:0] _003_;
  ...
  wire [11:0] mid_pipe_add_shamt_q;
  wire [0:1] mid_pipe_aux_q;
  wire [0:1] mid_pipe_eff_sub_q;
  wire [13:0] mid_pipe_exp_diff_q;
  wire [13:0] mid_pipe_exp_prod_q;
  ...
  wire [73:0] mid_pipe_sum_q;
  wire [3:0] mid_pipe_tag_q;
  wire [13:0] mid_pipe_tent_exp_q;
  ...
  wire tentative_sign;
  wire uf_after_round;
  assign exponent_addend = $signed({ 2'h0, operand_c[14:10] }) + $signed({ 6'h00, _059_ });
  assign _021_ = { 2'h0, exponent_a[4:0] } + info_a[6];
  assign _022_ = _021_ + { 2'h0, operand_b[14:10] };
  assign _023_ = _022_ + info_b[6];
  assign _024_ = { 13'h0000, product, 2'h0 } + addend_shifted;
  assign sum_raw = _024_ + inject_carry_in;
  assign _026_ = 32'd13 + leading_zero_count;
  assign _025_ = $signed(_073_) + $signed(32'd1);
  assign _027_ = $signed(32'd13) + $signed(mid_pipe_exp_prod_q[6:0]);
  ...
  reg [36:0] _106_;
  always @(posedge clk_i, negedge rst_ni)
    if (!rst_ni) _106_ <= 37'h0000000000;
    else if (\gen_inside_pipeline[0].reg_ena ) _106_ <= mid_pipe_sum_q[73:37];
  assign mid_pipe_sum_q[36:0] = _106_;
  ...
  assign _035_ = sum_raw[37] == tentative_sign;
  ...
  assign _039_ = $signed(exponent_difference) <= $signed(32'd4294967273);
  assign _040_ = $signed(exponent_difference) <= $signed(32'd13);
  assign _041_ = $signed(mid_pipe_exp_diff_q[6:0]) <= $signed(32'd0);
  assign _042_ = $signed(mid_pipe_exp_diff_q[6:0]) <= $signed(32'd2);
  ...
  assign _012_ = _038_ ? sum_shifted[35:24] : { 1'h0, sum_shifted[35:25] };
  assign _016_ = _038_ ? { sum_shifted[23:0], 1'h0 } : sum_shifted[24:0];
  assign _011_ = _038_ ? _074_[6:0] : 7'h00;
  assign _003_ = sum_shifted[36] ? normalized_exponent : _011_;
  assign _010_ = sum_shifted[36] ? sum_shifted[24:0] : _016_;
  assign _004_ = sum_shifted[36] ? { 1'h1, sum_shifted[35:25] } : _012_;
  assign final_mantissa = sum_shifted[37] ? { 1'h1, sum_shifted[36:26] } : _004_;
  assign sum_sticky_bits = sum_shifted[37] ? sum_shifted[25:1] : _010_;
  assign final_exponent = sum_shifted[37] ? _028_[6:0] : _003_;
  assign _006_ = _050_ ? _025_[6:0] : 7'h00;
  assign _005_ = _050_ ? _026_[5:0] : _027_[5:0];
  assign normalized_exponent = _055_ ? _006_ : mid_pipe_tent_exp_q[6:0];
  assign norm_shamt = _055_ ? _005_ : mid_pipe_add_shamt_q[5:0];
  assign _002_ = _040_ ? _072_[5:0] : 6'h00;
  assign addend_shamt = _039_ ? 6'h25 : _002_;
  assign _020_ = info_c[4] ? { operand_c[15], 15'h7c00 } : 16'h7e00;
  assign _019_ = _053_ ? { tentative_sign, 15'h7c00 } : _020_;
  assign _018_ = _046_ ? 1'h1 : 1'h0;
  assign _017_ = _046_ ? 16'h7e00 : _019_;
  assign _015_ = any_operand_inf ? _018_ : 1'h0;
  assign _014_ = any_operand_inf ? _017_ : 16'h7e00;
  ...
  assign { exponent_a[4:0], mantissa_a[9:0] } = _193_(15'h0401, { 15'h3c00, inp_pipe_operands_q[14:0] }, { _066_, _034_ });
  ...
  assign operand_c = _196_(16'h8401, { _081_, inp_pipe_operands_q[46:32], 16'h8000 }, { _031_, _065_ });
  assign operand_b = _033_ ? inp_pipe_operands_q[31:16] : 16'h8401;
  function [7:0] _198_;
    input [7:0] a;
    input [15:0] b;
    input [1:0] s;
  ...
  assign sum_shifted = mid_pipe_sum_q[36:0] << norm_shamt;
  assign { addend_after_shift, addend_sticky_bits } = { info_c[7], operand_c[9:0], 37'h0000000000 } >> addend_shamt;
  assign _071_ = _023_ - 32'd15;
  assign exponent_difference = $signed(exponent_addend) - $signed(exponent_product);
  assign _072_ = $signed(32'd14) - $signed(exponent_difference);
  assign _073_ = $signed(mid_pipe_exp_prod_q[6:0]) - $signed({ 1'h0, leading_zero_count });
  ...
  assign { _076_[31:7], exponent_product } = _054_ ? 32'd4294967283 : _071_;
  ...
  assign { _077_[37], mid_pipe_sum_q[73:37] } = _047_ ? _056_ : sum_raw;
  ...
  assign { _080_[31:5], pre_round_abs[14:10] } = of_before_round ? 32'd30 : { 27'h0000000, final_exponent[4:0] };
  ...
  \$paramod$f43ad4497f2ebae4f4fcbeb78548f418a29e40f3\lzc  i_lzc (
    ...
    .empty_o(lzc_zeroes),
    .in_i(mid_pipe_sum_q[24:0])
  );
  assign _076_[6:0] = exponent_product;
  assign _077_[36:0] = mid_pipe_sum_q[73:37];
  assign _080_[4:0] = pre_round_abs[14:10];
  assign addend_shamt_q = mid_pipe_add_shamt_q[5:0];
  ...
  assign exponent_difference_q = mid_pipe_exp_diff_q[6:0];
  assign exponent_product_q = mid_pipe_exp_prod_q[6:0];
  ...
  assign mid_pipe_add_shamt_q[11:6] = addend_shamt;
  assign mid_pipe_aux_q[0] = inp_pipe_aux_q[1];
  assign mid_pipe_eff_sub_q[0] = effective_subtraction;
  assign mid_pipe_exp_diff_q[13:7] = exponent_difference;
  assign mid_pipe_exp_prod_q[13:7] = exponent_product;
  ...
  assign mid_pipe_tent_exp_q[13:7] = sv2v_tmp_B4C85;
  ...
  assign sum = mid_pipe_sum_q[73:37];
  assign sum_carry = sum_raw[37];
  assign sum_lower = mid_pipe_sum_q[24:0];
  assign sum_q = mid_pipe_sum_q[36:0];
  ...
  assign sv2v_tmp_CEAB3 = mid_pipe_sum_q[73:37];
  ...
  assign tentative_exponent_q = mid_pipe_tent_exp_q[6:0];
endmodule

module \$paramod$3c9122f9385dabc95d01fa816ea328ecaab3929d\fpnew_top_21317_11D0A (clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  input flush_i;
  wire flush_i;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7883$195.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7883$41.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$127.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$162.$result ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$211.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$227.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$243.op ;
  wire [3:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$259.op ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$57.$result ;
  wire [1:0] \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$92.$result ;
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1151  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1151 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1151 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1151 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1151 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1151 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1151 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1151 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1151 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1151 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1151 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1151 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1151 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1151 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1151 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1151 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1151 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$162.$result  = \$auto$proc_rom.cc:150:do_switch$1151 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1155  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1155 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1155 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1155 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1155 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1155 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1155 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1155 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1155 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1155 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1155 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1155 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1155 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1155 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1155 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1155 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1155 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$127.$result  = \$auto$proc_rom.cc:150:do_switch$1155 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1159  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1159 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1159 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1159 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1159 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1159 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1159 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1159 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1159 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1159 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1159 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1159 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1159 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1159 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1159 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1159 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1159 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$92.$result  = \$auto$proc_rom.cc:150:do_switch$1159 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1163  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1163 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1163 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1163 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1163 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1163 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1163 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1163 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1163 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1163 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1163 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1163 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1163 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1163 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1163 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1163 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1163 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$57.$result  = \$auto$proc_rom.cc:150:do_switch$1163 [op_i];
  reg [1:0] \$auto$proc_rom.cc:150:do_switch$1167  [15:0];
  initial begin
    \$auto$proc_rom.cc:150:do_switch$1167 [0] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1167 [1] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1167 [2] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1167 [3] = 2'h0;
    \$auto$proc_rom.cc:150:do_switch$1167 [4] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1167 [5] = 2'h1;
    \$auto$proc_rom.cc:150:do_switch$1167 [6] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1167 [7] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1167 [8] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1167 [9] = 2'h2;
    \$auto$proc_rom.cc:150:do_switch$1167 [10] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1167 [11] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1167 [12] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1167 [13] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1167 [14] = 2'h3;
    \$auto$proc_rom.cc:150:do_switch$1167 [15] = 2'h2;
  end
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7883$41.$result  = \$auto$proc_rom.cc:150:do_switch$1167 [op_i];
  ...
  assign _03_ = ! \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$57.$result ;
  assign _04_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$92.$result  == 2'h1;
  assign _05_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$127.$result  == 2'h2;
  assign _06_ = \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$162.$result  == 2'h3;
  assign busy_o = | opgrp_busy;
  wire [3:0] _35_ = opgrp_in_ready;
  assign _07_ = _35_[\fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7883$41.$result  +: 1];
  ...
  \$paramod$2c3f0f0ab5cf2e7e1dc2c81d2f6435db1d0dee7d\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[0].i_opgroup_block  (
    .busy_o(opgrp_busy[0]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$98a6d05beb5a1f6e9108250b9a6e77d8a756961d\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[1].i_opgroup_block  (
    .busy_o(opgrp_busy[1]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$ae50834d9d4c9d126ef33c9417f13122fa5da22c\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[2].i_opgroup_block  (
    .busy_o(opgrp_busy[2]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  \$paramod$7eba445c75a972b9ec62909011841552f2391fa4\fpnew_opgroup_block_A94B6_B7406  \gen_operation_groups[3].i_opgroup_block  (
    .busy_o(opgrp_busy[3]),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
  ...
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7883$195.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$211.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$227.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$243.op  = 4'hx;
  assign \fpnew_pkg_get_opgroup$func$FPNewBlackbox_H1l2s.preprocessed.v:7932$259.op  = 4'hx;
...
module \$paramod$447df5b3a283065710c022398bea8ef33f939a95\rr_arb_tree_DE4E6_76EE6 (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:327$436.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:327$437.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:347$434.inp ;
  wire [1:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:347$435.inp ;
  ...
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:327$436.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:327$437.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:347$434.inp  = 2'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:347$435.inp  = 2'hx;
endmodule
...
module \$paramod$5445c4b4831d267c76d70f214646a25bf1d94aa9\fpnew_classifier (operands_i, is_boxed_i, info_o);
  ...
  input [47:0] operands_i;
  wire [47:0] operands_i;
  assign _000_ = ! operands_i[14:10];
  assign _002_ = ! operands_i[30:26];
  assign _004_ = ! operands_i[46:42];
  assign _001_ = ! operands_i[9:0];
  assign _003_ = ! operands_i[25:16];
  assign _005_ = ! operands_i[41:32];
  ...
  assign _036_ = | operands_i[14:10];
  assign _037_ = operands_i[14:10] != 5'h1f;
  assign _038_ = | operands_i[30:26];
  assign _039_ = operands_i[30:26] != 5'h1f;
  assign _040_ = | operands_i[46:42];
  assign _041_ = operands_i[46:42] != 5'h1f;
...
module \$paramod$65a6fd5a1b819e7d7d2a2211773490ca20062739\fpnew_opgroup_fmt_slice_E368D_75924 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i, busy_o);
  output busy_o;
  wire busy_o;
  input clk_i;
  wire clk_i;
  ...
  \$paramod$362e4fefcada2c1e759d925fe54e5e56d459c241\fpnew_fma_FC83A_5615B  \gen_num_lanes[0].active_lane.lane_instance.i_fma  (
...
module \$paramod$7eba445c75a972b9ec62909011841552f2391fa4\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module \$paramod$98a6d05beb5a1f6e9108250b9a6e77d8a756961d\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module \$paramod$ae50834d9d4c9d126ef33c9417f13122fa5da22c\fpnew_opgroup_block_A94B6_B7406 (clk_i, rst_ni, operands_i, is_boxed_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, extension_bit_o, tag_o, out_valid_o, out_ready_i
, busy_o);
  wire _0_;
  wire [23:0] arbiter_output;
  output busy_o;
...
module \$paramod$ea0afc4617438da89f766dca3e2e990528ae0bae\rr_arb_tree_52163_F264E (clk_i, rst_ni, flush_i, rr_i, req_i, gnt_o, data_i, req_o, gnt_i, data_o, idx_o);
  ...
  input rst_ni;
  wire rst_ni;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:149$524.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:149$525.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$508.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$509.$result ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$518.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$519.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$520.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$521.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$522.inp ;
  wire [2:0] \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$523.inp ;
  assign _01_ = req_i[1] & \gen_arbiter.rr_q [0];
  assign _02_ = req_i[3] & \gen_arbiter.rr_q [0];
  ...
  assign idx_o = \gen_arbiter.gen_levels[0].gen_level[0].sel  ? { 1'h1, \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$508.$result [1:0] } : { 1'h0, \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$509.$result [1:0] };
  assign { \gen_arbiter.index_nodes [5], \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$509.$result [1:0] } = \gen_arbiter.gen_levels[1].gen_level[0].sel  ? { 2'h1, \gen_arbiter.gen_levels[2].gen_level[1].sel  } : { 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel  };
  assign { \gen_arbiter.index_nodes [8], \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$508.$result [1:0] } = req_i[4] ? 3'h0 : 3'h2;
  ...
  assign { \gen_arbiter.index_nodes [20:9], \gen_arbiter.index_nodes [7:6], \gen_arbiter.index_nodes [4:0] } = { 8'h00, \gen_arbiter.gen_levels[2].gen_level[1].sel , 2'h0, \gen_arbiter.gen_levels[2].gen_level[0].sel , \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$508.$result [1:0], \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$509.$result [1:0], idx_o };
  assign \gen_arbiter.req_d  = req_i;
  assign { \gen_arbiter.req_nodes [6:5], \gen_arbiter.req_nodes [2], \gen_arbiter.req_nodes [0] } = { 1'h0, req_i[4], req_i[4], req_o };
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:149$524.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:149$525.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$508.$result [2] = 1'h1;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$509.$result [2] = 1'h0;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$518.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$519.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$520.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$521.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$522.inp  = 3'hx;
  assign \sv2v_cast_29535$func$FPNewBlackbox_H1l2s.preprocessed.v:169$523.inp  = 3'hx;
endmodule
...
module FPNewBlackbox(clk_i, rst_ni, operands_i, rnd_mode_i, op_i, op_mod_i, src_fmt_i, dst_fmt_i, int_fmt_i, vectorial_op_i, tag_i, in_valid_i, in_ready_o, flush_i, result_o, status_o, tag_o, out_valid_o, out_ready_i, busy_o);
  ...
  input vectorial_op_i;
  wire vectorial_op_i;
  \$paramod$3c9122f9385dabc95d01fa816ea328ecaab3929d\fpnew_top_21317_11D0A  inst (
    .busy_o(busy_o),
    .clk_i(clk_i),
    .dst_fmt_i(dst_fmt_i),
    .flush_i(flush_i),
